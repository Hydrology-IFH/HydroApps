        ...
        <slot name="colorbar-elements">
          <div class="colorbar-elements">
            <div
              ...
              :key="element.label"
              :class="`colorbar-${element.type}`"
            >
              <slot v-if="element.type=='con'">
                <div
                  class="colorbar-bar"
                  :style="cb_style(element.colors)"
                />
                <div class="colorbar-ticks">
                  <div
                    v-for="(label, index) in element.labels"
                    :key="label.label"
                    class="colorbar-tick"
              ...
              <slot v-else>
                <div class="colorbar-color">
                  <div :style="{ background: element.color, opacity: opacity }" />
                </div>
